...
// vib3 K26 variant: widen the IS_MLA gate to accept 64 heads (K2.6) in
// addition to the upstream 128-head DeepSeek-V3 shape.
#define IS_MLA ((HEAD_GRP_SIZE == 128 || HEAD_GRP_SIZE == 64) && HEAD_ELEMS == 576)

#if IS_MLA
#if defined(VIB3_MLA_K26)
